...
{
    public const string ERROR_MESSAGE = 'image_manipulator_error';
    public const string ERROR_FILE_CLOSED = 'image_manipulator_file_closed_error';
    public const string ERROR_FILE_WRITE_FAILED = 'image_manipulator_file_write_failed';
