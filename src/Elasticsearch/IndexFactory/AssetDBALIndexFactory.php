...
final readonly class AssetDBALIndexFactory implements DBALIndexFactoryInterface
{
    ...
    public function buildFromArray(
        ...
        return [
            ...
            'keywordNames' => $array['keyword_names'],
            'authorIds' => $array['author_ids'],
            'authorNames' => $array['author_names'],
            ...
            'uploadedAt' => $array['dates_uploaded_at']->getTimestamp(),
            ...
            'ttsAudio' => (bool) $array['asset_flags_tts_audio'],
