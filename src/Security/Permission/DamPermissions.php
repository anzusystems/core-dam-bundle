...
class DamPermissions
{
    ...
    public const string DAM_ASSET_VIEW = 'dam_asset_view';
    ...
    public const string DAM_VIDEO_VIEW = 'dam_video_view';
    ...
    public const string DAM_AUDIO_VIEW = 'dam_audio_view';
    ...
    public const string DAM_CUSTOM_FORM_VIEW = 'dam_assetCustomForm_view';

    // Custom Form Element
    public const string DAM_CUSTOM_FORM_ELEMENT_VIEW = 'dam_customFormElement_view';

    // Document
    public const string DAM_DOCUMENT_CREATE = 'dam_document_create';
    public const string DAM_DOCUMENT_UPDATE = 'dam_document_update';
    public const string DAM_DOCUMENT_VIEW = 'dam_document_view';
    ...
    public const string DAM_IMAGE_VIEW = 'dam_image_view';
    ...
    public const string DAM_REGION_OF_INTEREST_VIEW = 'dam_regionOfInterest_view';
    ...
    public const string DAM_EXT_SYSTEM_VIEW = 'dam_extSystem_view';
    ...
    public const string DAM_ASSET_LICENCE_VIEW = 'dam_assetLicence_view';
    ...
    public const string DAM_ASSET_LICENCE_GROUP_VIEW = 'dam_assetLicenceGroup_view';
    ...
    public const string DAM_AUTHOR_VIEW = 'dam_author_view';
    ...
    public const string DAM_KEYWORD_VIEW = 'dam_keyword_view';
    ...
    public const string DAM_PODCAST_VIEW = 'dam_podcast_view';
    ...
    public const string DAM_PODCAST_EPISODE_VIEW = 'dam_podcastEpisode_view';
    ...
    public const string DAM_DISTRIBUTION_CATEGORY_VIEW = 'dam_distributionCategory_view';
    ...
    public const string DAM_DISTRIBUTION_CATEGORY_SELECT_VIEW = 'dam_distributionCategorySelect_view';
    ...
    public const string DAM_DISTRIBUTION_VIEW = 'dam_distribution_view';
    ...
    public const string DAM_PERMISSION_GROUP_VIEW = 'dam_permissionGroup_view';
    ...
    public const string DAM_VIDEO_SHOW_VIEW = 'dam_videoShow_view';
    ...
    public const string DAM_VIDEO_SHOW_EPISODE_VIEW = 'dam_videoShowEpisode_view';
    ...
    // Job
    public const string DAM_JOB_VIEW = 'dam_job_view';
