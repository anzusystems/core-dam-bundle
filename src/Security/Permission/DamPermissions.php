...
class DamPermissions
{
    ...
    public const string DAM_ASSET_VIEW = 'dam_asset_read';
    ...
    public const string DAM_VIDEO_VIEW = 'dam_video_read';
    ...
    public const string DAM_AUDIO_VIEW = 'dam_audio_read';
    ...
    public const string DAM_CUSTOM_FORM_VIEW = 'dam_assetCustomForm_read';
    ...
    public const string DAM_DOCUMENT_VIEW = 'dam_document_read';
    ...
    public const string DAM_IMAGE_VIEW = 'dam_image_read';
    ...
    public const string DAM_REGION_OF_INTEREST_VIEW = 'dam_regionOfInterest_read';
    ...
    public const string DAM_EXT_SYSTEM_VIEW = 'dam_extSystem_read';
    ...
    public const string DAM_ASSET_LICENCE_VIEW = 'dam_assetLicence_read';
    ...
    public const string DAM_ASSET_LICENCE_GROUP_VIEW = 'dam_assetLicenceGroup_read';
    ...
    public const string DAM_AUTHOR_VIEW = 'dam_author_read';
    ...
    public const string DAM_KEYWORD_VIEW = 'dam_keyword_read';
    ...
    public const string DAM_PODCAST_VIEW = 'dam_podcast_read';
    ...
    public const string DAM_PODCAST_EPISODE_VIEW = 'dam_podcastEpisode_read';
    ...
    public const string DAM_DISTRIBUTION_CATEGORY_VIEW = 'dam_distributionCategory_read';
    ...
    public const string DAM_PERMISSION_GROUP_VIEW = 'dam_permissionGroup_read';
    ...
    public const string DAM_VIDEO_SHOW_VIEW = 'dam_videoShow_read';
    ...
    public const string DAM_VIDEO_SHOW_EPISODE_VIEW = 'dam_videoShowEpisode_read';
