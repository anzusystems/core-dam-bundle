...
#[Route(path: '/voice-elevenlabs', name: 'adm_voice_elevenlabs_v1_')]
#[OA\Tag('ElevenlabsVoice')]
final class ElevenlabsVoiceController extends AbstractApiController
{
    ...
    #[OARequest(ElevenlabsVoice::class), OAResponse(ElevenlabsVoice::class), OAResponseValidation]
    public function create(Request $request, #[SerializeParam] ElevenlabsVoice $voice): JsonResponse
    {
    ...
    #[OAParameterPath('voice'), OARequest(ElevenlabsVoice::class), OAResponse(ElevenlabsVoice::class), OAResponseValidation]
    public function update(Request $request, ElevenlabsVoice $voice, #[SerializeParam] ElevenlabsVoice $newVoice): JsonResponse
    {
        App::throwOnReadOnlyMode();
