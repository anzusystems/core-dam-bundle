...
* **BC break**: `ExtSystemCallbackInterface` gains a required `isImageFileUsedBulk()` method — every implementor must add it; an id the ext system cannot answer for is left out of the returned map rather than reported as used
